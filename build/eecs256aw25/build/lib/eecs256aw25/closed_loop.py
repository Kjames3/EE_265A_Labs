...
class Turtlebot(Node):
    ...
    def run(self):
        ...
        # Thresholds
        dist_threshold = 0.1 # Increased from 0.05 to avoid missing waypoints during fly-by
        angle_threshold = 0.05 # ~2.8 degrees
        ...
        for target in waypoints:
            ...
            while rclpy.ok():
                ...
                # Note: target velocity is 0, so D-term pushes against current velocity
                ...
                time.sleep(0.01) # 100Hz control loop for smoothness
            ...
            while rclpy.ok():
                ...
                if (current_time_log % 1000000000) < 20000000: # Rough 1Hz log
